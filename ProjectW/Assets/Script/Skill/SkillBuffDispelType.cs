...
public class SkillBuffDispelType : SkillEffectBase, ISkillDispelTurnSkill
{
    ...
    {
        var allDispel = targetActor.data.turnSkill.FindAll(_ => _.GetTable().effect_tag == EFFECT_TAG.EFFECT_TAG_BUFF);
